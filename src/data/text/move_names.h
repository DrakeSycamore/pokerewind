const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_SNAP] = _("Snap"),
    [MOVE_MORDANT_ACID] = _("Mordant Acid"),
    [MOVE_BEAR_HUG] = _("Bear Hug"),
    [MOVE_LENS_FLARE] = _("Lens Flare"),
    [MOVE_JUSTICE_HAMMER] = _("Storm Hammer"),
    [MOVE_GENTLE_RAIN] = _("Gentle Rain"),
    [MOVE_LEAD_CANNON] = _("Lead Cannon"),
    ...
    [MOVE_BLUE_SCREEN] = _("Blue Screen"),
    [MOVE_SPIN_DASH] = _("Spin Dash"),
    [MOVE_SYNTH_WAVE] = _("Synth Wave"),
    ...
    [MOVE_EJECT] = _("Eject"),
    [MOVE_TOXIC_ATTITUDE] = _("Toxicity"),
